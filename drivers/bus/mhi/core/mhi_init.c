...
void mhi_deinit_dev_ctxt(struct mhi_controller *mhi_cntrl)
{
	...
	/* mhi_ctxt may already be freed by a previous deinit call
	 * (e.g. mhi_power_down followed by mhi_unprepare_after_power_down).
	 * Guard against NULL dereference at mhi_ctxt->cmd_ctxt (offset 0x10).
	 */
	if (!mhi_ctxt)
		return;
